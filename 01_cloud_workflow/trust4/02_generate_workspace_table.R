...
output_table_path <-
    file.path(terra_parameter_directory, "workspace_table.trust.tsv")

raw_file_text <- "
    trust_clones_result_directory   gs://fc-secure-b93dcb7d-39d9-47ff-9bd9-b281cb9a69de/results/trust_clones_result_directory
    trust_suffix    trust_clones.txt
"
