...
# Principle behind the script:
# Simple can be harder than complex.
# You have to work hard to get your thinking clean to make it simple.
# But it's worth it in the end because once you get there, you can move mountains.


# This script will create a file called myWorkflow_inputs.json
...
terra_parameter_directory <-
    file.path("..", "terra_parameters.trust") %T>%
    dir.create(., showWarnings = F, recursive = T)

output_inputs_json_path <- file.path(terra_parameter_directory, "inputs.trust.json")
output_outputs_json_path <- file.path(terra_parameter_directory, "outputs.trust.json")
