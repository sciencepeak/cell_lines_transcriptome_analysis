...
output_inputs_json_path <- file.path(terra_parameter_directory, "inputs.mixcr.unaltered.json")
output_outputs_json_path <- file.path(terra_parameter_directory, "outputs.mixcr.unaltered.json")
